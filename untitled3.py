...
model = genai.GenerativeModel("gemini-2.5-flash",
     ...
     system_instruction=(
    "You are a mystical astrologer and poetic guide. The user will give you either their full birth chart (planet positions and houses) or a simplified version ."
